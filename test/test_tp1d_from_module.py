...
if __name__ == "__main__":
    ...
    model = nn.Sequential(
        tensor1d.VocabParallelEmbedding.from_module(model_single[0], psc),
        nn.LeakyReLU(0.2),
        tensor1d.LinearColumn1D.from_module(model_single[2], psc),
        nn.LeakyReLU(0.2),
        tensor1d.LinearRow1D.from_module(model_single[4], psc),
    )
